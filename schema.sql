...
CREATE SEQUENCE issue_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('issue_id_seq' :: regclass);
...
ALTER TABLE
    ONLY resource
ADD
    CONSTRAINT resource_pkey PRIMARY KEY (path, dataset);
...
ALTER TABLE
    "statement" DROP COLUMN "unique";

--- 2022-05-18: rename url to key in cache table.
ALTER TABLE
    "cache" RENAME COLUMN "url" TO "key";
...
ALTER TABLE
    "statement"
ADD
    COLUMN "lang" character varying(255) DEFAULT NULL;

ALTER TABLE
    "statement"
ADD
    COLUMN "original_value" character varying(65535) DEFAULT NULL;
